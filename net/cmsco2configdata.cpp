...
CmsCo2ConfigData::CmsCo2ConfigData(CmsModuleID identifier, CmsLabelID label)
    : CmsConfigData(identifier, label)
{

}

CmsCo2ConfigData::~CmsCo2ConfigData()
{

}

void CmsCo2ConfigData::setConfig(Co2ConfigField config)
{
    this->configField = config;
}

Co2ConfigField CmsCo2ConfigData::config() const
{
    return this->configField;
}

bool CmsCo2ConfigData::decodePacket(const QByteArray &arr)
{
...
QByteArray CmsCo2ConfigData::encodePacket() const
{
